...
<p><strong>Tarc Ishva</strong> is a new-age residential project representing sheer class at the prestigious location of Sector 63A, Golf Course Extension Road, Gurgaon. This luxury development isn’t just about premium living—it's about creating a sense of belonging within thoughtfully crafted 3 & 4 BHK residences.</p>
<p>Strategically located, <strong>Tarc Ishva</strong> offers unmatched connectivity and a lifestyle filled with comfort and elegance. Spread across 7 acres, this new launch is more than just an address—it's an experience shaped by excellence.</p>
<p>With best-in-class amenities curated for every age group, it ensures a fulfilling life for every member of the family. Tarc Developers, known for their commitment to timely delivery and quality, bring a project that promises to redefine price benchmarks and living standards in Sector 63A, Gurgaon.</p>    <button class="btn btn-warning text-white" data-bs-toggle="modal" data-bs-target="#contactModal">Get Details →</button>
</div>
            <!-- Right Column: Image -->
...
<ul style="list-style: none; padding-left: 0; font-size: 15px;">
    <li>🏢 <strong>4 Side Open Residences:</strong> Maximum ventilation and natural light.</li>
    <li>🧬 <strong>Thoughtfully Planned Ecosystem:</strong> Designed with lifestyle balance in mind.</li>
    <li>🌿 <strong>Lush Landscape:</strong> Verdant green spaces throughout the premises.</li>
    <li>🛁 <strong>Jacuzzi:</strong> Luxurious spa experience at home.</li>
    <li>🏏 <strong>Cricket Net:</strong> For sports enthusiasts and practice sessions.</li>
    <li>🚴‍♂️ <strong>Jogging & Cycling Track:</strong> Dedicated tracks for fitness lovers.</li>
    <li>🏀 <strong>Multipurpose Sports Court:</strong> Perfect for basketball, tennis, and more.</li>
    <li>🏊 <strong>Swimming Pool + Deck:</strong> Refreshing pool with relaxing deck area.</li>
    <li>🔐 <strong>Multi-tier Security System:</strong> Advanced safety at every level.</li>
    <li>🏢 <strong>Double-height Glass Tower Drop-off:</strong> Grand entrance experience.</li>
    <li>🏔 <strong>Aravali Facing Units:</strong> Scenic views of the Aravali range.</li>
    <li>👨‍👩‍👧 <strong>Low Density:</strong> More space, fewer units, enhanced privacy.</li>
    <li>🏞 <strong>70% Open Area:</strong> Expansive open spaces for greenery and activities.</li>
    <li>🚪 <strong>1 to a Core Apartment:</strong> Exclusive privacy per floor.</li>
    <li>🛗 <strong>2 Personal Lifts per Apartment:</strong> Ultra-private and convenient access.</li>
</ul>
...
<ul style="list-style: none; padding-left: 0;">
    <li style="margin-bottom: 10px; font-size: 18px;">🏢 <strong>Elevation of 36 Floors:</strong> Iconic high-rise with panoramic views.</li>
    <li style="margin-bottom: 10px; font-size: 18px;">🌿 <strong>Grand Land Spread of 7 Acres:</strong> Expansive development for premium living.</li>
    <li style="margin-bottom: 10px; font-size: 18px;">🚪 <strong>2 Private Entrance Lobbies:</strong> Ensuring exclusivity and privacy.</li>
    <li style="margin-bottom: 10px; font-size: 18px;">⛰ <strong>Aravalli Facing:</strong> Serene views of the Aravalli Hills from select residences.</li>
    <li style="margin-bottom: 10px; font-size: 18px;">🌬 <strong>Four-Side Open Residences:</strong> Natural light and ventilation from all directions.</li>
    <li style="margin-bottom: 10px; font-size: 18px;">📍 <strong>Easy Connectivity:</strong> Seamless access to major hotspots and business centers.</li>
</ul>
...
<ul style="list-style: none; padding-left: 0; font-size: 18px;">
    <li style="margin-bottom: 10px;">⛳ <strong>5 Min Away From Golf Course Road:</strong> Premium connectivity to Gurgaon's prime boulevard.</li>
    <li style="margin-bottom: 10px;">✈️ <strong>40 Min From IGI Airport:</strong> Smooth access to international and domestic flights.</li>
    <li style="margin-bottom: 10px;">🚇 <strong>5 Mins from Metro Station:</strong> Quick and hassle-free public transport access.</li>
    <li style="margin-bottom: 10px;">🏥 <strong>Near Heritage School & Medanta Hospital:</strong> Top-tier education and healthcare within easy reach.</li>
    <li style="margin-bottom: 10px;">🛍️ <strong>Close To Worldmark & Hongkong Bazar:</strong> Shopping, dining, and entertainment at your doorstep.</li>
</ul>
