...
<p>In essence, <strong>Paras Manor</strong> redefines the idea of luxury, practicality, and socially focused apartment living—making it a highly sought-after choice for modern urban dwellers.</p>
...
<ul style="list-style: none; padding-left: 0; font-size: 16px;">
    <li>🏢 <strong>Triple Height Lobby</strong></li>
    <li>🏊 <strong>All Weather Pool</strong></li>
    <li>🏋️‍♂️ <strong>Professional Gymnasium</strong></li>
    <li>☕ <strong>Tropical Café and Lounge</strong></li>
    <li>🎯 <strong>Recreational Areas</strong></li>
    <li>📊 <strong>Full-size Meeting Rooms</strong></li>
    <li>🪟 <strong>Two Side Full Glass Façade</strong></li>
    <li>🚗 <strong>3 Level Parking</strong></li>
    <li>🌱 <strong>IGBC Platinum Rating</strong></li>
    <li>🧿 <strong>Vaastu Compliant</strong></li>
    <li>🛡️ <strong>5-tier Security System</strong></li>
    <li>🏞️ <strong>Panoramic Views of Aravallis</strong></li>
    <li>🧘 <strong>Buddhist Meditation Zone</strong></li>
    <li>🌴 <strong>Central Courtyard and Tropical Garden</strong></li>
    <li>🏙️ <strong>Two Apartments Per Floor</strong></li>
    <li>🌄 <strong>3 Sided Open</strong></li>
    <li>🏗️ <strong>Category A Earthquake Resistance</strong></li>
    <li>🛎️ <strong>24x7 Doormen</strong></li>
</ul>
...
<ul style="list-style: none; padding-left: 0;">
    <li style="margin-bottom: 10px; font-size: 18px;">📐 <strong>Spread Over 4.5 Acres with 116 Units</strong></li>
    <li style="margin-bottom: 10px; font-size: 18px;">🏢 <strong>33 Floors with Ground Level Structure</strong></li>
    <li style="margin-bottom: 10px; font-size: 18px;">💰 <strong>Starting Price: ₹9.50 Cr* Onwards</strong></li>
    <li style="margin-bottom: 10px; font-size: 18px;">🌟 <strong>25+ Luxury Amenities including Clubhouse, EV Charging & More</strong></li>
    <li style="margin-bottom: 10px; font-size: 18px;">🪟 <strong>Glass Balconies & Tall Windows Embracing Nature’s Beauty</strong></li>
</ul>
...
<ul style="list-style: none; padding-left: 0; font-size: 15px;">
    <li style="margin-bottom: 10px;">✈️ <strong>25 min Drive from IGI Airport</strong></li>
    <li style="margin-bottom: 10px;">🏌️ <strong>05 min Drive from TERI Golf Course</strong></li>
    <li style="margin-bottom: 10px;">🏫 <strong>Educational Nearby: Tiny Toons & Vallores Pre School – within 1.68 KM</strong></li>
    <li style="margin-bottom: 10px;">🏥 <strong>Healthcare: Janki Max & Tulasi Psychiatric Center – within 1.65 KM</strong></li>
    <li style="margin-bottom: 10px;">🚇 <strong>Connectivity: Sector 54 Chowk Metro & Golf Course Road – just 2.98 KM away</strong></li>
    <li style="margin-bottom: 10px;">🛍️ <strong>Shopping: Suncity & Navkriti Complexes – within 2.48 KM</strong></li>
    <li style="margin-bottom: 10px;">🏢 <strong>Business Hubs: Suncity Business Tower & Centrum Plaza – around 2.64 KM</strong></li>
    <li style="margin-bottom: 10px;">🛣️ <strong>Delhi Border – Just 2 mins Away</strong></li>
    <li style="margin-bottom: 10px;">🎓 <strong>Nearby: GD Goenka School & IT/ITES Corridor</strong></li>
    <li style="margin-bottom: 10px;">🌆 <strong>Excellent Connectivity to Golf Course Road & South Delhi</strong></li>
</ul>
