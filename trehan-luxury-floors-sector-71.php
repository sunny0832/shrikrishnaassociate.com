...
<body>
    ...
    <div class="container" >
        <div class="row align-items-center"> 
            <!-- Left Column: Content -->
            <div class="col-md-6">
            <h2>About Trehan Sector 71 Gurgaon</h2>
...
<p>Investing in <strong>Trehan Sector 71</strong> is an investment in long-term comfort and prosperity. With promising returns, it presents an excellent opportunity for those seeking value-driven real estate in Gurgaon’s ever-growing property market.</p>
...
<p>If you’re a homebuyer or investor, now is the perfect time to consider Trehan Sector 71. The property is <strong>RERA-approved</strong>, backed by easy and flexible payment plans, and offers a range of unit sizes to suit your specific requirements.</p>
<p>With strong connectivity to nearby sectors and just a short drive from the <strong>Indira Gandhi International Airport</strong>, <strong>Trehan 71 Low-Rise Floors</strong> is a promising and well-constructed project, developed using only the highest quality materials. It’s a top-tier residential opportunity in the heart of Gurgaon.</p>
...
<ul style="list-style: none; padding-left: 0; font-size: 15px;">
    <li>🔌 <strong>Power Backup</strong></li>
    <li>🍽️ <strong>Modular Kitchen</strong></li>
    <li>🛋️ <strong>Semi Furnished Units</strong></li>
    <li>🌇 <strong>Exclusive Rooftop Rights</strong></li>
    <li>📱 <strong>Smart Home Automation</strong></li>
    <li>🔥 <strong>Chimney & Hob Included</strong></li>
    <li>🎫 <strong>Smart Visitor Management System</strong></li>
    <li>📷 <strong>CCTV Surveillance</strong></li>
    <li>🔐 <strong>Smart Door Lock System</strong></li>
    <li>💧 <strong>Advanced Water Proofing</strong></li>
    <li>🛠️ <strong>2 Years of Free Maintenance*</strong></li>
</ul>
                ...
                <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="border: 2px solid #c79c3d; padding: 12px;">179 Sq. Yds.</td>
...
<ul style="list-style: none; padding-left: 0;">
    <li style="margin-bottom: 10px; font-size: 16px;">🚗 <strong>Covered Parking for Each Unit</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🏛️ <strong>Inspired by Traditional Architecture</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🎥 <strong>24x7 CCTV Monitoring for Enhanced Security</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🛋️ <strong>High-End Modular Wardrobes and Kitchens</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🌇 <strong>Spacious & Opulent Balconies</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🎨 <strong>Elegant and Thoughtfully Designed Interior Spaces</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🏢 <strong>5500 sq. m Club Area for Leisure & Recreation</strong></li>
</ul>
...
<ul style="list-style: none; padding-left: 0; font-size: 15px;">
    <li style="margin-bottom: 10px;">🛣️ <strong>1300m from SPR Road</strong></li>
    <li style="margin-bottom: 10px;">🛣️ <strong>1500m from Gurgaon-Sohna Road</strong></li>
    <li style="margin-bottom: 10px;">🏘️ <strong>Located Beside DLF Almida</strong></li>
    <li style="margin-bottom: 10px;">🛣️ <strong>Direct Connectivity to Dwarka Expressway and NH-8</strong></li>
    <li style="margin-bottom: 10px;">🏫 <strong>Close to Top Educational Institutes: GD Goenka, The Paras World School, DAV Public School, St. Xavier’s, etc.</strong></li>
    <li style="margin-bottom: 10px;">🛍️ <strong>Nearby Malls: Airia Mall, Element One, Good Earth City Centre, Omaxe City Centre</strong></li>
    <li style="margin-bottom: 10px;">🍽️ <strong>Popular Restaurants & Bars: 32 Avenue, M3M Broadway, Barbeque Nation, Hyatt Regency</strong></li>
    <li style="margin-bottom: 10px;">🚇 <strong>13 Minutes Drive to HUDA City Centre Metro Station</strong></li>
    <li style="margin-bottom: 10px;">🛍️ <strong>Only 5 Minutes from Airia Mall</strong></li>
    <li style="margin-bottom: 10px;">✈️ <strong>Approx. 25 Minutes Drive to IGI Airport</strong></li>
    <li style="margin-bottom: 10px;">🚝 <strong>15 Minutes Drive to Rapid Metro</strong></li>
</ul>
        ...
        <!-- Right Side - Image -->
        <div style="flex: 1 1 400px; max-width: 500px;">
            <img src="images/extra/Trehan-Sector-71-Gurgaon-Location-Map.webp" alt="Location Map" data-bs-toggle="modal" data-bs-target="#contactModal"  
