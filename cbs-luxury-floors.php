...
<p><strong>CBS Luxury Floors 63A</strong> – Sector 63A, Golf Course Extension Road, Gurgaon, offers exclusive 3BHK ultra-luxury builder floors. Developed by CBS Developers in Anantraj Estate, this project elevates your lifestyle to the next level.</p>
...
<p>CBS Floors in Sector 63A are well connected to all major roads and nearby areas. This location is easily accessible and high-profile, with over 1.2 million people living in the surrounding region. Strategically located in one of Gurgaon’s most rapidly growing and developing areas, this project offers proximity to major schools, malls, commercial centers, hospitals, and more.</p>
...
<ul style="list-style: none; padding-left: 0; font-size: 15px;">
    ...
    <li>🛡️ <strong>3 Tier Security</strong></li>
    <li>🌄 <strong>Mesmerizing View</strong></li>
    <li>🏀 <strong>Play Court</strong></li>
    <li>❄️ <strong>Fully Air Conditioned</strong></li>
    <li>🚗 <strong>Dedicated Car Parking</strong></li>
    <li>🏢 <strong>Club House</strong></li>
    <li>🛗 <strong>Dedicated Lift</strong></li>
    <li>📹 <strong>CCTV Surveillance</strong></li>
    <li>🍽️ <strong>Modular Kitchen</strong></li>
    <li>🌿 <strong>Lush Open Spaces</strong></li>
    <li>🌼 <strong>Central Lawn</strong></li>
    <li>👧 <strong>Kid’s Play Area</strong></li>
    <li>💪 <strong>Fitness Center</strong></li>
    <li>🏃‍♂️ <strong>Jogging Track</strong></li>
    <li>🚶 <strong>Low Density Development</strong></li>
    <li>🧘 <strong>Meditation Area</strong></li>
</ul>
...
<ul style="list-style: none; padding-left: 0;">
    <li style="margin-bottom: 10px; font-size: 16px;">📍 <strong>Located on Anant Raj Sector 63A, Gurgaon</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🏘️ <strong>3 & 4 BHK Luxury Low-Rise Floors</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🕒 <strong>Ready to Move in Luxury Floors</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">💰 <strong>Starting Price ₹ 2 Cr* onwards</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🏡 <strong>Ultra-luxurious Low-Rise Development</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🏘️ <strong>Duplex Villas & Apartments in City Center</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🌿 <strong>Lush Green Landscapes & Water Bodies</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🚪 <strong>Model Gateway at the Entrance</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🏥 <strong>Schools, Hospitals & Shopping Centers Nearby</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🚑 <strong>24-Hour Ambulance for Emergency</strong></li>
</ul>
...
<ul style="list-style: none; padding-left: 0; font-size: 15px;">
    <li style="margin-bottom: 10px;">📍 <strong>Proximity to Golf Course Extension Road</strong></li>
    <li style="margin-bottom: 10px;">✈️ <strong>30-minute drive to IGI International Airport</strong></li>
    <li style="margin-bottom: 10px;">🏥 <strong>10-minute drive to Park Hospitals</strong></li>
    <li style="margin-bottom: 10px;">🛣️ <strong>Just a 20-minute drive to Delhi NCR</strong></li>
    <li style="margin-bottom: 10px;">🚇 <strong>Well-connected to HUDA City Centre Metro Station</strong></li>
    <li style="margin-bottom: 10px;">🏫 <strong>Seamless connectivity to hospitals, schools, and colleges</strong></li>
    <li style="margin-bottom: 10px;">🕒 <strong>15-minute drive from IFFCO Chowk</strong></li>
    <li style="margin-bottom: 10px;">🛣️ <strong>Located around 7 km from Gurgaon–Faridabad Road</strong></li>
    <li style="margin-bottom: 10px;">🛤️ <strong>Sits at the crossing of NH-8 and 150m wide Dwarka Expressway</strong></li>
    <li style="margin-bottom: 10px;">🚉 <strong>Close proximity to the proposed Metro Station</strong></li>
    <li style="margin-bottom: 10px;">🏥 <strong>Rajiv Chowk is 8 km away from Medicity</strong></li>
    <li style="margin-bottom: 10px;">✈️ <strong>25 km away from IGI Airport</strong></li>
    <li style="margin-bottom: 10px;">🛍️ <strong>Near popular hospitals, schools, and shopping malls</strong></li>
    <li style="margin-bottom: 10px;">🌆 <strong>Well-developed social infrastructure around the project</strong></li>
    <li style="margin-bottom: 10px;">🎓 <strong>Renowned schools, colleges & malls built nearby</strong></li>
    <li style="margin-bottom: 10px;">🚗 <strong>Excellent connectivity through major roads & highways</strong></li>
</ul>
