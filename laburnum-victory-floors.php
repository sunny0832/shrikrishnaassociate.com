...
<body>
    ...
    <div style="display: inline-block; width: 100%; max-width: 1250px;">
        <img src="images/extra/banner-1.jpg" alt="Image"
    ...
    <div class="container" >
        <div class="row align-items-center"> 
            <!-- Left Column: Content -->
            <div class="col-md-6">
            <h2>About Laburnum Victory Floors</h2>
<p><strong>Laburnum Victory Floors</strong> is a place where all of your dreams of luxury living will come true. Developed by Laburnum Developers, this project is a perfect combination of <strong>luxury, comfort, and indulgence</strong>.</p>
<p>This residential community offers <strong>3BHK + Study luxury apartments</strong> and is strategically located on <strong>Golf Course Extension Road, Sector 63A, Gurgaon</strong> within the premium Anant Raj Estate. Experience the charm of low-rise majestic living in Victory Floors Sector 63A.</p>
<p>The apartments are intelligently designed to reflect opulence, offering a perfect blend of <strong>modernity and luxury</strong>. Surrounded by lush greenery and landscaped areas, the environment promotes healthy and serene living.</p>
<p>This project offers a range of <strong>unparalleled luxury amenities</strong> including <strong>CCTV surveillance, smart home automation, EV charging point, video door phone, vanity, lift, and more</strong>. Every feature is thoughtfully curated to deliver a lifestyle of comfort and convenience.</p>
<p><strong>Laburnum Victory Floors 63A</strong> enjoys excellent connectivity, being centrally located in Gurgaon. It provides seamless access to <strong>Huda City Metro Station, Rapid Metro, Dwarka Expressway, Sohna Road, Golf Course Extension Road</strong>, and <strong>Southern Peripheral Road (SPR)</strong>, making it easily accessible from other parts of Delhi-NCR.</p>
...
<ul style="list-style: none; padding-left: 0; font-size: 15px;">
    <li>🚪 <strong>Entrance and Exit Gate Plaza</strong></li>
    <li>🌿 <strong>Lush Lawn</strong></li>
    <li>🧘 <strong>Yoga Area</strong></li>
    <li>🧒 <strong>Kid’s Play Area</strong></li>
    <li>🏢 <strong>Club Facility</strong></li>
    <li>📹 <strong>CCTV Surveillance</strong></li>
    <li>🌳 <strong>Community Back Lawns</strong></li>
    <li>🏠 <strong>Smart Home Automation</strong></li>
    <li>🍳 <strong>Modular Kitchen</strong></li>
    <li>🎨 <strong>Elegant Interiors</strong></li>
    <li>🛁 <strong>Premium Bathroom Fittings</strong></li>
</ul>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-3">
                <div style="overflow: hidden; border-radius: 10px; height: 250px;">
                    <img src="images/extra/Victory-Floors-By-Laburnum-image-4-.webp" class="img-fluid rounded shadow" alt="Gallery Image 1" loading="lazy"
            ...
            <div class="col-md-3">
                <div style="overflow: hidden; border-radius: 10px; height: 250px;">
                    <img src="images/extra/about-us.jpg" class="img-fluid rounded shadow" alt="Gallery Image 4" loading="lazy" 
                        style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.3s ease-in-out;"
                        onmouseover="this.style.transform='scale(1.05)'" 
                        onmouseout="this.style.transform='scale(1)'">
                </div>
            ...
            <div class="col-md-3">
                <div style="overflow: hidden; border-radius: 10px; height: 250px;">
                    <img src="images/extra/gallery-2-.jpg" class="img-fluid rounded shadow" alt="Gallery Image 5" loading="lazy"
                        style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.3s ease-in-out;"
                        onmouseover="this.style.transform='scale(1.05)'" 
                        onmouseout="this.style.transform='scale(1)'">
                </div>
...
<div class="col-md-3">
                <div style="overflow: hidden; border-radius: 10px; height: 250px;">
                    <img src="images/extra/gallery-4.jpg" class="img-fluid rounded shadow" alt="Gallery Image 5" 
                    loading="lazy"  style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.3s ease-in-out;"
                        onmouseover="this.style.transform='scale(1.05)'" 
                        onmouseout="this.style.transform='scale(1)'">
                </div>
...
<section id="floorplan" style="padding: 60px 0; background-color:#bab777; text-align: center;">
    <div class="container" style="max-width: 1100px; margin: auto; padding: 0 20px;"><br>
        ...
        <div style="display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 40px;">
                ...
                <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="border: 2px solid #c79c3d; padding: 12px;">1700  SQ.FT</td>
            ...
            <div style="width: 100%; max-width: 500px; flex: 1; text-align: center;">
                <img src="images/extra/8559c3ea0fa9c7509d4f86fd00f9380e.webp" alt="Floor Plan"data-bs-toggle="modal" data-bs-target="#contactModal"  
...
<section id="highlights" style="background-color:#bab777; padding: 50px 0;">
    <div class="container">
        <div class="row align-items-center justify-content-center"> 
            ...
            <div class="col-md-6 text-center">
                <img src="images/extra/labernum-victory-g-2.webp" alt="Overview Image" class="img-fluid" 
...
<h2>Laburnum Victory Floors</h2>
<ul style="list-style: none; padding-left: 0;">
    <li style="margin-bottom: 10px; font-size: 16px;">🏠 <strong>Spacious Rooms & Balconies For Luxurious Living</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🌳 <strong>Open Spaces & Lush Greenery</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🏊‍♀️ <strong>Modern Amenities Including A Clubhouse & Pool</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🛣️ <strong>Excellent Connectivity To Major Hubs</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🏫 <strong>Close Proximity To Top Schools & Colleges</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🏢 <strong>Near IT Parks & Business Centers</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🛍️ <strong>Convenient Access To Shopping & Dining</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🧱 <strong>High-Quality Construction With Premium Materials</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">💪 <strong>State-Of-The-Art Fitness Center</strong></li>
</ul>
                <button class="btn btn-warning text-white" data-bs-toggle="modal" data-bs-target="#contactModal">
                    Get Details →
                </button>
...
<ul style="list-style: none; padding-left: 0; font-size: 15px;">
    <li style="margin-bottom: 10px;">🛍️ <strong>Shopping Complexes and Hospitals Located Nearby</strong></li>
    <li style="margin-bottom: 10px;">🛣️ <strong>2 Minute Drive from NH-8</strong></li>
    <li style="margin-bottom: 10px;">✈️ <strong>35 Minutes’ Drive from Indira Gandhi International Airport</strong></li>
    <li style="margin-bottom: 10px;">🚗 <strong>20 Minutes’ Drive from Delhi</strong></li>
    <li style="margin-bottom: 10px;">🚇 <strong>20 Minutes’ Drive from HUDA City Center Metro Station</strong></li>
    <li style="margin-bottom: 10px;">🛣️ <strong>Delhi Easily Accessible via Faridabad Road and MG Road</strong></li>
    <li style="margin-bottom: 10px;">🏥 <strong>Proximity to Reputed Schools & Hospitals</strong></li>
    <li style="margin-bottom: 10px;">📍 <strong>Sector 63 Gurgaon Strategically Located in the Rapidly Emerging Suburban Business District</strong></li>
</ul>
        ...
        <!-- Right Side - Image -->
        <div style="flex: 1 1 400px; max-width: 500px;">
            <img src="images/extra/Victory-Floors-By-Laburnum-Location-Map.webp" alt="Location Map" data-bs-toggle="modal" data-bs-target="#contactModal"  
