...
<p>The project is designed to cater to various age groups, cultures, and lifestyles—making it a truly intergenerational community. Out of the six residential towers, two are dedicated senior living residences, professionally managed by <strong>Antara Senior Living</strong>.</p>
<p>Whether you’re a young adult, a senior, or part of a growing family, <strong>Estate 360</strong> has something special for everyone. From wellness-oriented amenities to lifestyle-enhancing features, everything is thoughtfully distributed across the property.</p>
<p>Residents can enjoy a range of facilities at the community’s modern clubhouses—<strong>The Hub</strong> and <strong>The Antara Club</strong> (exclusively for seniors)—as well as throughout the beautifully landscaped estate.</p>
...
<ul style="list-style: none; padding-left: 0; font-size: 15px;">
    <li>🚫 <strong>Car-Free Ground Plaza</strong></li>
    <li>🌾 <strong>Countryside Landscape</strong></li>
    <li>✅ <strong>IGBC Platinum Pre-Certified</strong></li>
    <li>🏘️ <strong>Two Community Clubs</strong></li>
    <li>🏋️ <strong>1 Lac Sq. Ft. of Well-Being Amenities</strong></li>
    <li>🏏 <strong>Dedicated Sports Block</strong></li>
    <li>🏛️ <strong>State-of-the-Art Clubhouse</strong></li>
    <li>🌳 <strong>700 Trees with 33 Different Species</strong></li>
    <li>🌀 <strong>Wraparound Decks</strong></li>
    <li>🧑‍🤝‍🧑 <strong>Community Plaza</strong></li>
    <li>🔐 <strong>Gated Security</strong></li>
    <li>⛳ <strong>Golf Putting Area</strong></li>
    <li>🏊 <strong>Indoor All-Weather Pool</strong></li>
    <li>🎭 <strong>Amphitheatre</strong></li>
    <li>🎉 <strong>Party Terrace & Club Terrace</strong></li>
    <li>🏏 <strong>Cricket Pitch</strong></li>
    <li>👵 <strong>Expert Senior Care</strong></li>
    <li>🪷 <strong>Pool Deck</strong></li>
    <li>✨ <strong>60+ Modern Amenities</strong></li>
    <li>🏢 <strong>6 Residences Including 2 for Senior Living</strong></li>
</ul>
...
<ul style="list-style: none; padding-left: 0;">
    <li style="margin-bottom: 10px; font-size: 18px;">✨ <strong>Discover the Finest Features and Finishes</strong></li>
    <li style="margin-bottom: 10px; font-size: 18px;">🚫 <strong>Entire ground level is free from any vehicle moment</strong></li>
    <li style="margin-bottom: 10px; font-size: 18px;">🏫 <strong>Separate school entry</strong></li>
    <li style="margin-bottom: 10px; font-size: 18px;">🛍️ <strong>Retail inside the society</strong></li>
    <li style="margin-bottom: 10px; font-size: 18px;">🛗 <strong>5 elevator per tower | 3 Level Basement</strong></li>
    <li style="margin-bottom: 10px; font-size: 18px;">🏢 <strong>Wrap around balcony | Zig zag placement of towers</strong></li>
    <li style="margin-bottom: 10px; font-size: 18px;">🌿 <strong>Central Sunken courtyard area</strong></li>
</ul>
...
<ul style="list-style: none; padding-left: 0; font-size: 17px;">
    <li style="margin-bottom: 10px;">🛣️ <strong>Direct access to:</strong> Dwarka Expressway</li>
    <li style="margin-bottom: 10px;">🚌 <strong>Upcoming ISBT:</strong> 1 minute</li>
    <li style="margin-bottom: 10px;">🏙️ <strong>Cyber City 2 and Vision City:</strong> Nearby</li>
    <li style="margin-bottom: 10px;">🏢 <strong>IICC:</strong> 15 minutes</li>
    <li style="margin-bottom: 10px;">☕ <strong>Starbucks, PVR Inox, McDonald's, KFC, Chaayos, Theobroma:</strong> 2 minutes</li>
    <li style="margin-bottom: 10px;">🏫 <strong>Schools and Major Banks:</strong> Close proximity</li>
    <li style="margin-bottom: 10px;">🚉 <strong>Gurgaon Railway Station:</strong> 15 Km</li>
    <li style="margin-bottom: 10px;">✈️ <strong>Indira Gandhi International Airport:</strong> 25 Km</li>
</ul>
