...
<body>
    ...
    <div style="display: inline-block; width: 100%; max-width: 1250px;">
        <img src="images/extra/gallery50.webp" alt="Image" 
    ...
    <div class="container" >
        <div class="row align-items-center"> 
            <!-- Left Column: Content -->
            <div class="col-md-6">
            <h2>Signature Global Daxin Vistas Sector 35 Sohna, Gurugram</h2>

<p><strong>Signature Global Daxin Vistas</strong> is a prestigious residential township by Signature Global, strategically located in Sector 35 Sohna, Gurugram.</p>
<p><strong>Aravalli Facing Luxurious Residences:</strong> Designed with modern architecture and thoughtful planning, offering premium living spaces with scenic views.</p>
<p><strong>Spacious & Community-Centric:</strong> Spread across a thoughtfully designed township with tree-lined streets, open green spaces, and a grand clubhouse promoting relaxation and social interaction.</p>
<p><strong>Modern Clubhouse Amenities:</strong> Features world-class leisure and entertainment facilities, giving residents space to unwind, engage in activities, and build community bonds.</p>
<p><strong>Prime Connectivity:</strong> Located just before Sohna Toll Plaza, offering excellent access to Gurgaon’s key landmarks including schools, hospitals, shopping centers, and recreational hubs.</p>
<p><strong>Strategic Location:</strong> The township's address in Sector 35 Sohna ensures close proximity to essential services, making it ideal for families and professionals alike.</p>
<p><strong>Affordable Luxury Living:</strong> Signature Sohna combines elegance, affordability, and connectivity, making it a standout choice for a vibrant, modern lifestyle in South of Gurgaon.</p>

    <button class="btn btn-warning text-white" data-bs-toggle="modal" data-bs-target="#contactModal">Get Details →</button>
</div>
            <!-- Right Column: Image -->
            <div class="col-md-6 text-center">
                <img src="images/extra/gallery50.webp" alt="Overview Image" class="img-fluid" data-bs-toggle="modal" data-bs-target="#contactModal" style="max-width: 100%; height: auto; border-radius: 10px; box-shadow: 3px 8px 10px rgba(0, 0, 0, 0.4);">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container" style="max-width: 1100px; margin: auto; padding: 0 20px;">
        <div style="display: flex; flex-wrap: wrap; align-items: center; justify-content: center; gap: 30px;">
            ...
            <div style="flex: 1; max-width: 500px; display: flex; align-items: center; justify-content: center;">
                <img src="images/extra/gallery11.webp" alt="Project Features" 
        ...
        <div class="row g-3">
            ...
            <div class="col-md-3">
                <div style="overflow: hidden; border-radius: 10px; height: 250px;">
                    <img src="images/extra/gallery.webp" class="img-fluid rounded shadow" alt="Gallery Image 1" loading="lazy"
            ...
            <div class="col-md-3">
                <div style="overflow: hidden; border-radius: 10px; height: 250px;">
                    <img src="images/extra/gallery2.webp" class="img-fluid rounded shadow" alt="Gallery Image 2" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.3s ease-in-out;"
                        onmouseover="this.style.transform='scale(1.05)'" 
                        onmouseout="this.style.transform='scale(1)'">
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div style="overflow: hidden; border-radius: 10px; height: 250px;">
                    <img src="images/extra/gallery3.webp" class="img-fluid rounded shadow" alt="Gallery Image 3" 
            ...
            <div class="col-md-3">
                <div style="overflow: hidden; border-radius: 10px; height: 250px;">
                    <img src="images/extra/gallery40.webp" class="img-fluid rounded shadow" alt="Gallery Image 4" loading="lazy" 
                        style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.3s ease-in-out;"
                        onmouseover="this.style.transform='scale(1.05)'" 
                        onmouseout="this.style.transform='scale(1)'">
                </div>
            ...
            <div class="col-md-3">
                <div style="overflow: hidden; border-radius: 10px; height: 250px;">
                    <img src="images/extra/gallery50.webp" class="img-fluid rounded shadow" alt="Gallery Image 5" loading="lazy"
                        style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.3s ease-in-out;"
                        onmouseover="this.style.transform='scale(1.05)'" 
                        onmouseout="this.style.transform='scale(1)'">
                </div>
            ...
            <div class="col-md-3">
                <div style="overflow: hidden; border-radius: 10px; height: 250px;">
                    <img src="images/extra/gallery6.webp" class="img-fluid rounded shadow" alt="Gallery Image 6" loading="lazy"
                        style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.3s ease-in-out;"
                        onmouseover="this.style.transform='scale(1.05)'" 
                        onmouseout="this.style.transform='scale(1)'">
                </div>
            ...
            <div class="col-md-3">
                <div style="overflow: hidden; border-radius: 10px; height: 250px;">
                    <img src="images/extra/gallery8.webp" class="img-fluid rounded shadow" alt="Gallery Image 5"
                    loading="lazy" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.3s ease-in-out;"
                        onmouseover="this.style.transform='scale(1.05)'" 
                        onmouseout="this.style.transform='scale(1)'">
                </div>
...
<div class="col-md-3">
                <div style="overflow: hidden; border-radius: 10px; height: 250px;">
                    <img src="images/extra/gallery9.webp" class="img-fluid rounded shadow" alt="Gallery Image 5" 
                    loading="lazy"  style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.3s ease-in-out;"
                        onmouseover="this.style.transform='scale(1.05)'" 
                        onmouseout="this.style.transform='scale(1)'">
                </div>
        ...
        <div style="display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 40px;">
            ...
            <div style="width: 100%; max-width: 500px; flex: 1; text-align: center;">
                <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                    ...
                    <tbody>
                        <tr>
                            <td style="border: 2px solid #c79c3d; padding: 12px;">3.5 BHK + Basement</td>
                            <td style="border: 2px solid #c79c3d; padding: 12px;">1550 Sq. Ft.</td>
                            <td style="border: 2px solid #c79c3d; padding: 12px;">₹ 2 Cr**</td>
                        </tr>
                        <tr>
                            <td style="border: 2px solid #c79c3d; padding: 12px;">3.5 BHK + Terrace</td>
                            <td style="border: 2px solid #c79c3d; padding: 12px;">On Request</td>
                            <td style="border: 2px solid #c79c3d; padding: 12px;">₹ 2.2 Cr**</td>
                        </tr>
                        </tbody>
                </table>
                <!-- Download Button -->
            ...
            <div style="width: 100%; max-width: 500px; flex: 1; text-align: center;">
                <img src="images/extra/floorplan.webp" alt="Floor Plan" 
...
<section id="highlights" style="background-color:#bab777; padding: 50px 0;">
    <div class="container">
        <div class="row align-items-center justify-content-center"> 
            ...
            <div class="col-md-6">
            <h2 style="font-style: italic; color: #1c355e;">HIGHLIGHTS - Signature Global Daxin Vistas</h2>
<ul style="list-style: none; padding-left: 0;">
    <li style="margin-bottom: 10px; font-size: 18px;">🏗 <strong>Structure:</strong> Reinforced Cement Concrete Framed Structure for enhanced strength and durability.</li>
    <li style="margin-bottom: 10px; font-size: 18px;">📺 <strong>T.V, Telephone & Internet:</strong> Provided points of T.V and telephone, provision for intercom facility.</li>
    <li style="margin-bottom: 10px; font-size: 18px;">🛗 <strong>Elevators:</strong> Standard make & suitable capacity lifts shall be provided.</li>
    <li style="margin-bottom: 10px; font-size: 18px;">🚗 <strong>Car Parking Area:</strong> CC paving shall be provided at stilt floor car parking.</li>
    <li style="margin-bottom: 10px; font-size: 18px;">🪑 <strong>Sit outs:</strong> Kajaria / Johnson Ceramic/Porcelain tiles.</li>
    <li style="margin-bottom: 10px; font-size: 18px;">🚰 <strong>Plumbing/Sanitary:</strong> Concealed plumbing with branded CP and sanitary ware fittings.</li>
    <li style="margin-bottom: 10px; font-size: 18px;">💡 <strong>Electrical:</strong> Concealed copper wiring with modular switches of reputed make, with adequate light, fan, and power points.</li>
    <li style="margin-bottom: 10px; font-size: 18px;">🅿️ <strong>Dedicated Car Parking:</strong> All apartments come with assigned parking space.</li>
</ul>
...
<ul style="list-style: none; padding-left: 0; font-size: 18px;">
    <li>🛣 <strong>8 KM to Golf Course Road Extn.:</strong> Well-connected to prime business areas.</li>
    <li>🚦 <strong>11 KM to Subhash Chowk:</strong> Easy access to major Gurgaon junction.</li>
    <li>🛻 <strong>13 KM to Dwarka Expressway Cloverleaf:</strong> Smooth entry/exit via expressway.</li>
    <li>🏙 <strong>13 KM to Rajiv Chowk:</strong> Reach central Gurgaon in minutes.</li>
    <li>✈ <strong>30 KM to IGI Airport:</strong> Direct airport connectivity for hassle-free travel.</li>
    <li>🏗 <strong>Located on Delhi-Mumbai Industrial Corridor:</strong> Strategic growth location.</li>
    <li>🚘 <strong>Gurugram-Sohna Elevated Road:</strong> Hassle-free smooth drive experience.</li>
</ul>
            <!-- Button -->
        ...
        <!-- Right Side - Image -->
        <div style="flex: 1 1 400px; max-width: 500px;">
            <img src="images/extra/LocationMap1.jpg" alt="Location Map" data-bs-toggle="modal" data-bs-target="#contactModal"  
