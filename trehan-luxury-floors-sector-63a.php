...
<ul style="list-style: none; padding-left: 0;">
    <li style="margin-bottom: 10px; font-size: 16px;">🏠 <strong>Fully Automated, Smart Home Features</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🛠️ <strong>1st-year Free Maintenance</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🚗 <strong>Parking Covered for Each Unit</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🛋️ <strong>High-end Modular Wardrobes and Kitchens</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🏛️ <strong>Traditional Buildings</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🎨 <strong>Elegant Interior Spaces</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">🌇 <strong>Opulent Balconies</strong></li>
    <li style="margin-bottom: 10px; font-size: 16px;">📷 <strong>Smart CCTV, Built-In Alexa</strong></li>
</ul>
...
<ul style="list-style: none; padding-left: 0; font-size: 15px;">
    <li style="margin-bottom: 10px;">📍 <strong>Sector 63A: Located in Gurgaon’s top spot</strong></li>
    <li style="margin-bottom: 10px;">🚇 <strong>Rapid Metro Station (Sector-56) – 7 mins</strong></li>
    <li style="margin-bottom: 10px;">🛣️ <strong>Sohna Road – 10 mins</strong></li>
    <li style="margin-bottom: 10px;">🛣️ <strong>IFFCO Chowk – 20 mins</strong></li>
    <li style="margin-bottom: 10px;">✈️ <strong>IGI Airport – 35-40 minutes</strong></li>
    <li style="margin-bottom: 10px;">🛣️ <strong>Well connected to Sohna Road, SPR, NH-8</strong></li>
    <li style="margin-bottom: 10px;">🛣️ <strong>Direct connectivity from Dwarka Expressway, Delhi-Mumbai Expressway</strong></li>
    <li style="margin-bottom: 10px;">🏫 <strong>Nearby Schools: DPS, GD Goenka University, IILM University, Amity International School</strong></li>
    <li style="margin-bottom: 10px;">🏥 <strong>Nearby Hospitals: Artemis, Fortis, Paras Hospital</strong></li>
</ul>
